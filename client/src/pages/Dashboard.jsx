  ...
  const uploadFile = (e) => {
    ...
    const createTree = (data) => {
      ...
      for (const key in data) {
        ...
        li.style.color = typeof data[key] === "string" ? "green" : "blue";
        li.style.fontWeight = typeof data[key] === "string" ? "bold" : "normal";
        li.style.listStyleType =
          typeof data[key] === "string" ? "none" : "circle";
        li.style.marginLeft = typeof data[key] === "string" ? "0px" : "20px";
        li.style.marginBottom = typeof data[key] === "string" ? "0px" : "10px";
        li.style.fontSize = typeof data[key] === "string" ? "16px" : "14px";
        li.style.fontFamily =
        ...
        li.style.borderRadius = typeof data[key] === "string" ? "0px" : "5px";
        li.style.backgroundColor =
          typeof data[key] === "string" ? "transparent" : "#f5f5f5";
        li.style.border =
          typeof data[key] === "string" ? "none" : "1px solid #e5e5e5";
        li.style.userSelect = typeof data[key] === "string" ? "none" : "auto";
        li.style.textDecoration =
          typeof data[key] === "string" ? "none" : "underline";
        li.style.textDecorationColor =
          typeof data[key] === "string" ? "none" : "#e5e5e5";
        li.style.textDecorationStyle =
          typeof data[key] === "string" ? "none" : "dotted";
        li.style.textDecorationThickness =
          typeof data[key] === "string" ? "none" : "1px";
      }
      return ul;
